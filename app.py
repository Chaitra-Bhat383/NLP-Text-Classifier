...
def main():
    ...
    if choice == "Home":
        ...
        st.subheader("About")
        st.write("I m Chaitra Bhat and this is my simple NLP Project using streamlit for Project TestBench. In this  NLP project I built a text classifier model for emotion detection in text. ")
